...
filename <- sprintf("outputs/species_richness/%s_%s_fold%s_marginal_prob_SR_%s_%s.rds",
                    model_id,
                    dataset_id,
                    fold_id,
                    start_sample,
...
filename <- sprintf("outputs/species_richness/%s_%s_fold%s_marginal_bin_SR_%s_%s.rds",
                    model_id,
                    dataset_id,
                    fold_id,
                    start_sample,
